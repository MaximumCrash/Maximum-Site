  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'The archived works and collaborative efforts of Réjon Taylor-Foster.' },
      ...
      { property: 'og:description', content: 'The archived works and collaborative efforts of Réjon Taylor-Foster.'},
      ...
      { name: 'twitter:description', content: 'The archived works and collaborative efforts of Réjon Taylor-Foster.'},
